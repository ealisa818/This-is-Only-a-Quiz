...
var questionBank= [
    ...
    function createQuiz () {
        ...
        for (i=0; i<questionBank[currentIndex].choices.length; i++) {
            ...
            currentAnswer.onclick=CheckAnswer
    ...
    //      }
             if (CheckAnswer == questionBank[currentIndex].answer) {
             score++
             alert("Correct!")
             console.log("Correct")
             currentIndex++
             ...
             else {(CheckAnswer !== questionBank[currentIndex].answer) 
    ...
    function countdown() {
        ...
        var countdown = document.querySelector("#countdowon")
